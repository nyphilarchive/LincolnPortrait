...
//   var TSG = {};
//
//   TSG.canvas = document.getElementById('c');
//   TSG.annotatedImage = document.getElementById('annotated-image');
//   TSG.annotatedImage2  = document.getElementById('annotated-image2');
//
...
var annotatedImageDetails = {
  ...
  toggleAnnotation: function(){
    $('#annotation-1').css('top',canvas.offsetTop+(this.y)*($('#c').height()/OGCanvasSize.height)+this.offsetY);
    $('#annotation-1').css('left',canvas.offsetLeft+(this.x)*($('#c').width()/OGCanvasSize.width)+this.offsetX);
...
window.onload = function(){
  ...
  $('#zoomIn').on('click', function(){
    ...
    console.log("zoom in coords x:"+pt.x+" y:"+pt.y);
